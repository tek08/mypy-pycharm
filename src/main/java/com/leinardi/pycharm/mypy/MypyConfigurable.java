...
public class MypyConfigurable implements Configurable {
    ...
    public boolean isModified() {
        boolean result = !configPanel.getMypyPath().equals(mypyConfigService.getCustomMypyPath())
                ...
                || configPanel.isAutodetectPipenvEnvironmentsEnabled() != mypyConfigService.isAutodetectPipenvEnvironmentsEnabled();
    ...
    public void apply() {
        ...
        mypyConfigService.setAutodetectPipenvEnvironmentsEnabled(configPanel.isAutodetectPipenvEnvironmentsEnabled());
    }
